...
In [part 1](https://ortelius.io/blog/2024/03/27/how-to-bake-an-ortelius-pi-part-1-the-hardware/) of this series we installed Ubuntu Server 22.04.4 LTS on our Raspberry Pi's. In part two we will prepare our three Pi's for DHCP, DNS, NFS (Network File System) storage with a [Synology NAS](https://www.synology.com/) and install [MicroK8s](https://microk8s.io/).
...
By this stage you should have three Pi's each ready with NFS and MicroK8s. Stay tuned for part 3 where we will deploy [Cloudflare](https://www.cloudflare.com/en-gb/), deploy the NSF [csi-driver-nfs](https://github.com/kubernetes-csi/csi-driver-nfs) for Kubernetes, deploy [Traefik](https://traefik.io/) and [Ortelius](https://ortelius.io/)
