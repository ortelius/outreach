...
By this stage you should have three Pi's each with NFS and MicroK8s. Stay tuned for part 3 where we will deploy [Cloudflare](https://www.cloudflare.com/en-gb/), deploy the NSF [csi-driver-nfs](https://github.com/kubernetes-csi/csi-driver-nfs) for Kubernetes, deploy [Traefik](https://traefik.io/) and [Ortelius](https://ortelius.io/)
